                ...
                <div className="cs_hero cs_style_1 cs_type_1 cs_bg_filed cs_primary_bg cs_center" data-background={item.img}>
                  <div className="container">
                    <div className="cs_hero_text">
                      <h1 style={{color:"#FFB800"}} className="cs_hero_title cs_fs_70 cs_mb_18 wow fadeInUp">{item.title}</h1>
                      <p style={{color:"white"}} className="cs_hero_subtitle cs_mb_34">{item.desc}</p>
